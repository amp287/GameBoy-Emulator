...
static INSTR opcodes[] = {
	...
	{"RRA", RRA, A, NA},			//0x1F
	{"JR NZ, n", JR_cc_n, NZ, READ_8},		//0x20		//NZ is check for Not zero
	...
	{"DAA", DAA, NA, NA},			//0x27
	{"JR Z, n", JR_cc_n, Z, READ_8},		//0x28		//Z is check for zero
	...
	{"CPL", CPL, NA, NA},			//0x2F
	{"JR NC, n", JR_cc_n, NC, READ_8},		//0x30		//NC is check for no carry
	...
	{"SCF", SCF, NA, NA},			//0x37
	{"JR C, n", JR_cc_n, C, READ_8},		//0x38		//C is check for carry
	...
	{"CP A", CP_n, NA, A},		//0xBF
	{"RET NZ", RET_cc, NZ, NA},		//0xC0		//NZ means check for not zero
	{"POP BC", POP_nn, BC, NA},		//0xC1
	{"JP NZ, nn", JP_cc_nn, NZ, READ_16},	//0xC2
	{"JP nn", JP_nn, NA, READ_16 },	//0xC3
	{"CALL NZ, nn", CALL_cc_nn, NZ, READ_16},//0xC4
	{"PUSH BC", PUSH_nn, BC, NA},	//0xC5
	{"ADD A, n", ADD_A_n, READ_8, READ_8},	//0xC6
	{"RST 0", RST_n, 0, NA},		//0xC7
	{"RET Z", RET_cc, Z, NA },		//0xC8
	{"RET", RET, NA, NA },		//0xC9
	{"JP Z, nn", JP_cc_nn, Z, READ_16},	//0xCA
	{"Ext Ops (CB)", NULL, NA, NA},	//0xCB
	{"CALL Z, nn", CALL_cc_nn, Z, READ_16},	//0xCC
	{"CALL nn", CALL_nn, NA, READ_16},		//0xCD
	{"ADC A, n", ADC_A_n, READ_8, READ_8},		//0xCE
	{"RST 8", RST_n, 8, NA},		//0xCF
	{"RET NC", RET_cc, NC, NA},		//0xD0
	{"POP DE", POP_nn, DE, NA},		//0xD1
	{"JP NC, nn", JP_cc_nn, NC, READ_16},	//0xD2
	{"XX", NULL, NA, NA},			//0xD3
	{"CALL NC, nn", CALL_cc_nn, NC, READ_16},	//0xD4
	{"PUSH DE", PUSH_nn, DE, NA},		//0xD5
	{"SUB A, n", SUB_n, READ_8, READ_8},		//0xD6
	{"RST 10", RST_n, 0x10, NA},		//0xD7
	{"RET C", RET_cc, C, NA},			//0xD8
	{"RETI", NULL, NA, NA},			//0xD9
	{"JP C, nn", JP_cc_nn, C, READ_16},		//0xDA
	{"XX", NULL, NA, NA},			//0xDB
	{"CALL cc, nn", CALL_cc_nn, C, READ_16},		//0xDC
	{"XX", NULL, NA, NA},			//0xDD
	...
	{"RST 38", RST_n, 0x28, NA},		//0xFF
};

static INSTR opcodesCB[] = {
	{ "RLC B", RLC_n, B, NA },           //0xCB 00
	{ "RLC C", RLC_n, C, NA },           //0xCB 01
	{ "RLC D", RLC_n, D, NA },           //0xCB 02
	{ "RLC E", RLC_n, E, NA },           //0xCB 03
	{ "RLC H", RLC_n, H, NA },           //0xCB 04
	{ "RLC L", RLC_n, L, NA },           //0xCB 05
	{ "RLC HL", RLC_n, HL, NA },         //0xCB 06
	{ "RLC A", RLC_n, A, NA },           //0xCB 07
	{ "RRC B", RRC_n, B, NA },           //0xCB 08
	{ "RRC C", RRC_n, C, NA },           //0xCB 09
	{ "RRC D", RRC_n, D, NA },           //0xCB 0A
	{ "RRC E", RRC_n, E, NA },           //0xCB 0B
	{ "RRC H", RRC_n, H, NA },           //0xCB 0C
	{ "RRC L", RRC_n, L, NA },           //0xCB 0D
	{ "RRC HL", RRC_n, HL, NA },         //0xCB 0E
	{ "RRC A", RRC_n, A, NA },           //0xCB 0F

	{ "RL B", RL_n, B, NA },            //0xCB 10
	{ "RL C", RL_n, C, NA },            //0xCB 11
	{ "RL D", RL_n, D, NA },            //0xCB 12
	{ "RL E", RL_n, E, NA },            //0xCB 13
	{ "RL H", RL_n, H, NA },            //0xCB 14
	{ "RL L", RL_n, L, NA },            //0xCB 15
	{ "RL HL", RL_n, HL, NA },          //0xCB 16
	{ "RL A", RL_n, A, NA },            //0xCB 17
	{ "RR B", RR_n, B, NA },            //0xCB 18
	{ "RR C", RR_n, C, NA },            //0xCB 19
	{ "RR D", RR_n, D, NA },            //0xCB 1A
	{ "RR E", RR_n, E, NA },            //0xCB 1B
	{ "RR H", RR_n, H, NA },            //0xCB 1C
	{ "RR L", RR_n, L, NA },            //0xCB 1D
	{ "RR HL", RR_n, HL, NA },          //0xCB 1E
	{ "RR A", RR_n, A, NA },            //0xCB 1F

	{ "SLA B", SLA_n, B, NA },           //0xCB 20
	{ "SLA C", SLA_n, C, NA },           //0xCB 21
	{ "SLA D", SLA_n, D, NA },           //0xCB 22
	{ "SLA E", SLA_n, E, NA },           //0xCB 23
	{ "SLA H", SLA_n, H, NA },           //0xCB 24
	{ "SLA L", SLA_n, L, NA },           //0xCB 25
	{ "SLA HL", SLA_n, HL, NA },         //0xCB 26
	{ "SLA A", SLA_n, A, NA },           //0xCB 27
	{ "SRA B", SRA_n, B, NA },           //0xCB 28
	{ "SRA C", SRA_n, C, NA },           //0xCB 29
	{ "SRA D", SRA_n, D, NA },           //0xCB 2A
	{ "SRA E", SRA_n, E, NA },           //0xCB 2B
	{ "SRA H", SRA_n, H, NA },           //0xCB 2C
	{ "SRA L", SRA_n, L, NA },           //0xCB 2D
	{ "SRA HL", SRA_n, HL, NA },         //0xCB 2E
	{ "SRA A", SRA_n, A, NA },           //0xCB 2F
	...
	{ "SRL B", SRL_n, B, NA },           //0xCB 38
	{ "SRL C", SRL_n, C, NA },           //0xCB 39
	{ "SRL D", SRL_n, D, NA },           //0xCB 3A
	{ "SRL E", SRL_n, E, NA },           //0xCB 3B
	{ "SRL H", SRL_n, H, NA },           //0xCB 3C
	{ "SRL L", SRL_n, L, NA },           //0xCB 3D
	{ "SRL HL", SRL_n, HL, NA },         //0xCB 3E
	{ "SRL A", SRL_n, A, NA },           //0xCB 3F

	{ "BIT 0 B", BIT_b_r, 0, B },            //0xCB 40
	{ "BIT 0 C", BIT_b_r, 0, C },            //0xCB 41
	{ "BIT 0 D", BIT_b_r, 0, D },            //0xCB 42
	{ "BIT 0 E", BIT_b_r, 0, E },            //0xCB 43
	{ "BIT 0 H", BIT_b_r, 0, H },            //0xCB 44
	{ "BIT 0 L", BIT_b_r, 0, L },            //0xCB 45
	{ "BIT 0 HL", BIT_b_r, 0, HL },          //0xCB 46
	{ "BIT 0 A", BIT_b_r, 0, A },            //0xCB 47
	{ "BIT 1 B", BIT_b_r, 1, B },            //0xCB 48
	{ "BIT 1 C", BIT_b_r, 1, C },            //0xCB 49
	{ "BIT 1 D", BIT_b_r, 1, D },            //0xCB 4A
	{ "BIT 1 E", BIT_b_r, 1, E },            //0xCB 4B
	{ "BIT 1 H", BIT_b_r, 1, H },            //0xCB 4C
	{ "BIT 1 L", BIT_b_r, 1, L },            //0xCB 4D
	{ "BIT 1 HL", BIT_b_r, 1, HL },          //0xCB 4E
	{ "BIT 1 A", BIT_b_r, 1, A },            //0xCB 4F

	{ "BIT 2 B", BIT_b_r, 2, B },            //0xCB 50
	{ "BIT 2 C", BIT_b_r, 2, C },            //0xCB 51
	{ "BIT 2 D", BIT_b_r, 2, D },            //0xCB 52
	{ "BIT 2 E", BIT_b_r, 2, E },            //0xCB 53
	{ "BIT 2 H", BIT_b_r, 2, H },            //0xCB 54
	{ "BIT 2 L", BIT_b_r, 2, L },            //0xCB 55
	{ "BIT 2 HL", BIT_b_r, 2, HL },          //0xCB 56
	{ "BIT 2 A", BIT_b_r, 2, A },            //0xCB 57
	{ "BIT 3 B", BIT_b_r, 3, B },            //0xCB 58
	{ "BIT 3 C", BIT_b_r, 3, C },            //0xCB 59
	{ "BIT 3 D", BIT_b_r, 3, D },            //0xCB 5A
	{ "BIT 3 E", BIT_b_r, 3, E },            //0xCB 5B
	{ "BIT 3 H", BIT_b_r, 3, H },            //0xCB 5C
	{ "BIT 3 L", BIT_b_r, 3, L },            //0xCB 5D
	{ "BIT 3 HL", BIT_b_r, 3, HL },          //0xCB 5E
	{ "BIT 3 A", BIT_b_r, 3, A },            //0xCB 5F

	{ "BIT 4 B", BIT_b_r, 4, B },            //0xCB 60
	{ "BIT 4 C", BIT_b_r, 4, C },            //0xCB 61
	{ "BIT 4 D", BIT_b_r, 4, D },            //0xCB 62
	{ "BIT 4 E", BIT_b_r, 4, E },            //0xCB 63
	{ "BIT 4 H", BIT_b_r, 4, H },            //0xCB 64
	{ "BIT 4 L", BIT_b_r, 4, L },            //0xCB 65
	{ "BIT 4 HL", BIT_b_r, 4, HL },          //0xCB 66
	{ "BIT 4 A", BIT_b_r, 4, A },            //0xCB 67
	{ "BIT 5 B", BIT_b_r, 5, B },            //0xCB 68
	{ "BIT 5 C", BIT_b_r, 5, C },            //0xCB 69
	{ "BIT 5 D", BIT_b_r, 5, D },            //0xCB 6A
	{ "BIT 5 E", BIT_b_r, 5, E },            //0xCB 6B
	{ "BIT 5 H", BIT_b_r, 5, H },            //0xCB 6C
	{ "BIT 5 L", BIT_b_r, 5, L },            //0xCB 6D
	{ "BIT 5 HL", BIT_b_r, 5, HL },          //0xCB 6E
	{ "BIT 5 A", BIT_b_r, 5, A },            //0xCB 6F

	{ "BIT 6 B", BIT_b_r, 6, B },            //0xCB 70
	{ "BIT 6 C", BIT_b_r, 6, C },            //0xCB 71
	{ "BIT 6 D", BIT_b_r, 6, D },            //0xCB 72
	{ "BIT 6 E", BIT_b_r, 6, E },            //0xCB 73
	{ "BIT 6 H", BIT_b_r, 6, H },            //0xCB 74
	{ "BIT 6 L", BIT_b_r, 6, L },            //0xCB 75
	{ "BIT 6 HL", BIT_b_r, 6, HL },          //0xCB 76
	{ "BIT 6 A", BIT_b_r, 6, A },            //0xCB 77
	{ "BIT 7 B", BIT_b_r, 7, B },            //0xCB 78
	{ "BIT 7 C", BIT_b_r, 7, C },            //0xCB 79
	{ "BIT 7 D", BIT_b_r, 7, D },            //0xCB 7A
	{ "BIT 7 E", BIT_b_r, 7, E },            //0xCB 7B
	{ "BIT 7 H", BIT_b_r, 7, H },            //0xCB 7C
	{ "BIT 7 L", BIT_b_r, 7, L },            //0xCB 7D
	{ "BIT 7 HL", BIT_b_r, 7, HL },          //0xCB 7E
	{ "BIT 7 A", BIT_b_r, 7, A },            //0xCB 7F

	{ "RES 0 B", RES_b_r, 0, B },            //0xCB 80
	{ "RES 0 C", RES_b_r, 0, C },            //0xCB 81
	{ "RES 0 D", RES_b_r, 0, D },            //0xCB 82
	{ "RES 0 E", RES_b_r, 0, E },            //0xCB 83
	{ "RES 0 H", RES_b_r, 0, H },            //0xCB 84
	{ "RES 0 L", RES_b_r, 0, L },            //0xCB 85
	{ "RES 0 HL", RES_b_r, 0, HL },          //0xCB 86
	{ "RES 0 A", RES_b_r, 0, A },            //0xCB 87
	{ "RES 1 B", RES_b_r, 1, B },            //0xCB 88
	{ "RES 1 C", RES_b_r, 1, C },            //0xCB 89
	{ "RES 1 D", RES_b_r, 1, D },            //0xCB 8A
	{ "RES 1 E", RES_b_r, 1, E },            //0xCB 8B
	{ "RES 1 H", RES_b_r, 1, H },            //0xCB 8C
	{ "RES 1 L", RES_b_r, 1, L },            //0xCB 8D
	{ "RES 1 HL", RES_b_r, 1, HL },          //0xCB 8E
	{ "RES 1 A", RES_b_r, 1, A },            //0xCB 8F

	{ "RES 2 B", RES_b_r, 2, B },            //0xCB 90
	{ "RES 2 C", RES_b_r, 2, C },            //0xCB 91
	{ "RES 2 D", RES_b_r, 2, D },            //0xCB 92
	{ "RES 2 E", RES_b_r, 2, E },            //0xCB 93
	{ "RES 2 H", RES_b_r, 2, H },            //0xCB 94
	{ "RES 2 L", RES_b_r, 2, L },            //0xCB 95
	{ "RES 2 HL", RES_b_r, 2, HL },          //0xCB 96
	{ "RES 2 A", RES_b_r, 2, A },            //0xCB 97
	{ "RES 3 B", RES_b_r, 3, B },            //0xCB 98
	{ "RES 3 C", RES_b_r, 3, C },            //0xCB 99
	{ "RES 3 D", RES_b_r, 3, D },            //0xCB 9A
	{ "RES 3 E", RES_b_r, 3, E },            //0xCB 9B
	{ "RES 3 H", RES_b_r, 3, H },            //0xCB 9C
	{ "RES 3 L", RES_b_r, 3, L },            //0xCB 9D
	{ "RES 3 HL", RES_b_r, 3, HL },          //0xCB 9E
	{ "RES 3 A", RES_b_r, 3, A },            //0xCB 9F

	{ "RES 4 B", RES_b_r, 4, B },			//0xCB A0
	{ "RES 4 C", RES_b_r, 4, C },			//0xCB A1
	{ "RES 4 D", RES_b_r, 4, D },			//0xCB A2
	{ "RES 4 E", RES_b_r, 4, E },			//0xCB A3
	{ "RES 4 H", RES_b_r, 4, H },			//0xCB A4
	{ "RES 4 L", RES_b_r, 4, L },			//0xCB A5
	{ "RES 4 HL", RES_b_r, 4, HL },			//0xCB A6
	{ "RES 4 A", RES_b_r, 4, A },			//0xCB A7
	{ "RES 5 B", RES_b_r, 5, B },			//0xCB A8
	{ "RES 5 C", RES_b_r, 5, C },			//0xCB A9
	{ "RES 5 D", RES_b_r, 5, D },			//0xCB AA
	{ "RES 5 E", RES_b_r, 5, E },			//0xCB AB
	{ "RES 5 H", RES_b_r, 5, H },			//0xCB AC
	{ "RES 5 L", RES_b_r, 5, L },			//0xCB AD
	{ "RES 5 HL", RES_b_r, 5, HL },			//0xCB AE
	{ "RES 5 A", RES_b_r, 5, A },			//0xCB AF

	{ "RES 6 B", RES_b_r, 6, B },			//0xCB B0
	{ "RES 6 C", RES_b_r, 6, C },			//0xCB B1
	{ "RES 6 D", RES_b_r, 6, D },			//0xCB B2
	{ "RES 6 E", RES_b_r, 6, E },			//0xCB B3
	{ "RES 6 H", RES_b_r, 6, H },			//0xCB B4
	{ "RES 6 L", RES_b_r, 6, L },			//0xCB B5
	{ "RES 6 HL", RES_b_r, 6, HL },			//0xCB B6
	{ "RES 6 A", RES_b_r, 6, A },			//0xCB B7
	{ "RES 7 B", RES_b_r, 7, B },			//0xCB B8
	{ "RES 7 C", RES_b_r, 7, C },			//0xCB B9
	{ "RES 7 D", RES_b_r, 7, D },			//0xCB BA
	{ "RES 7 E", RES_b_r, 7, E },			//0xCB BB
	{ "RES 7 H", RES_b_r, 7, H },			//0xCB BC
	{ "RES 7 L", RES_b_r, 7, L },			//0xCB BD
	{ "RES 7 HL", RES_b_r, 7, HL },			//0xCB BE
	{ "RES 7 A", RES_b_r, 7, A },			//0xCB BF

	{ "SET 0 B", SET_b_r, 0, B },			//0xCB C0
	{ "SET 0 C", SET_b_r, 0, C },			//0xCB C1
	{ "SET 0 D", SET_b_r, 0, D },			//0xCB C2
	{ "SET 0 E", SET_b_r, 0, E },			//0xCB C3
	{ "SET 0 H", SET_b_r, 0, H },			//0xCB C4
	{ "SET 0 L", SET_b_r, 0, L },			//0xCB C5
	{ "SET 0 HL", SET_b_r, 0, HL },			//0xCB C6
	{ "SET 0 A", SET_b_r, 0, A },			//0xCB C7
	{ "SET 1 B", SET_b_r, 1, B },			//0xCB C8
	{ "SET 1 C", SET_b_r, 1, C },			//0xCB C9
	{ "SET 1 D", SET_b_r, 1, D },			//0xCB CA
	{ "SET 1 E", SET_b_r, 1, E },			//0xCB CB
	{ "SET 1 H", SET_b_r, 1, H },			//0xCB CC
	{ "SET 1 L", SET_b_r, 1, L },			//0xCB CD
	{ "SET 1 HL", SET_b_r, 1, HL },			//0xCB CE
	{ "SET 1 A", SET_b_r, 1, A },			//0xCB CF

	{ "SET 2 B", SET_b_r, 2, B },            //0xCB D0
	{ "SET 2 C", SET_b_r, 2, C },            //0xCB D1
	{ "SET 2 D", SET_b_r, 2, D },            //0xCB D2
	{ "SET 2 E", SET_b_r, 2, E },            //0xCB D3
	{ "SET 2 H", SET_b_r, 2, H },            //0xCB D4
	{ "SET 2 L", SET_b_r, 2, L },            //0xCB D5
	{ "SET 2 HL", SET_b_r, 2, HL },          //0xCB D6
	{ "SET 2 A", SET_b_r, 2, A },            //0xCB D7
	{ "SET 3 B", SET_b_r, 3, B },            //0xCB D8
	{ "SET 3 C", SET_b_r, 3, C },            //0xCB D9
	{ "SET 3 D", SET_b_r, 3, D },            //0xCB DA
	{ "SET 3 E", SET_b_r, 3, E },            //0xCB DB
	{ "SET 3 H", SET_b_r, 3, H },            //0xCB DC
	{ "SET 3 L", SET_b_r, 3, L },            //0xCB DD
	{ "SET 3 HL", SET_b_r, 3, HL },          //0xCB DE
	{ "SET 3 A", SET_b_r, 3, A },            //0xCB DF

	{ "SET 4 B", SET_b_r, 4, B },            //0xCB E0
	{ "SET 4 C", SET_b_r, 4, C },            //0xCB E1
	{ "SET 4 D", SET_b_r, 4, D },            //0xCB E2
	{ "SET 4 E", SET_b_r, 4, E },            //0xCB E3
	{ "SET 4 H", SET_b_r, 4, H },            //0xCB E4
	{ "SET 4 L", SET_b_r, 4, L },            //0xCB E5
	{ "SET 4 HL", SET_b_r, 4, HL },          //0xCB E6
	{ "SET 4 A", SET_b_r, 4, A },            //0xCB E7
	{ "SET 5 B", SET_b_r, 5, B },            //0xCB E8
	{ "SET 5 C", SET_b_r, 5, C },            //0xCB E9
	{ "SET 5 D", SET_b_r, 5, D },            //0xCB EA
	{ "SET 5 E", SET_b_r, 5, E },            //0xCB EB
	{ "SET 5 H", SET_b_r, 5, H },            //0xCB EC
	{ "SET 5 L", SET_b_r, 5, L },            //0xCB ED
	{ "SET 5 HL", SET_b_r, 5, HL },          //0xCB EE
	{ "SET 5 A", SET_b_r, 5, A },            //0xCB EF

	{ "SET 6 B", SET_b_r, 6, B },            //0xCB F0
	{ "SET 6 C", SET_b_r, 6, C },            //0xCB F1
	{ "SET 6 D", SET_b_r, 6, D },            //0xCB F2
	{ "SET 6 E", SET_b_r, 6, E },            //0xCB F3
	{ "SET 6 H", SET_b_r, 6, H },            //0xCB F4
	{ "SET 6 L", SET_b_r, 6, L },            //0xCB F5
	{ "SET 6 HL", SET_b_r, 6, HL },          //0xCB F6
	{ "SET 6 A", SET_b_r, 6, A },            //0xCB F7
	{ "SET 7 B", SET_b_r, 7, B },            //0xCB F8
	{ "SET 7 C", SET_b_r, 7, C },            //0xCB F9
	{ "SET 7 D", SET_b_r, 7, D },            //0xCB FA
	{ "SET 7 E", SET_b_r, 7, E },            //0xCB FB
	{ "SET 7 H", SET_b_r, 7, H },            //0xCB FC
	{ "SET 7 L", SET_b_r, 7, L },            //0xCB FD
	{ "SET 7 HL", SET_b_r, 7, HL },          //0xCB FE
	{ "SET 7 A", SET_b_r, 7, A },            //0xCB FF
};
